...
Batters: As you can see, the distribution of free agent salary is heavily focued on smaller contracts, with very few players receiving million dollar salaries. To do linear regression, we'll want to transform our response variable in order to see a normal distribution. Using a log transformation will achieve that.
...
Pitchers: We see a similar distribution of salaries for pitchers as we did for batters, with a heavy focus on smaller contracts and very few large contracts. Again, we will want to log transform our response variable in order to do linear regression.
